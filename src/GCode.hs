...
import Data.List
import Text.Printf
import qualified Data.GCode.Types as GT
import Types
...
toString :: GCodeFlavor -> Int -> GT.GCode -> String
...
toStringOld :: GCodeFlavor -> Int -> [GCodeOp] -> String
toStringOld (GCodeFlavor begin end on off) dpi gops 
    = begin ++
      "\n" ++ 
      intercalate "\n" (toString' gops (0,0) True) ++ 
      "\n" ++ 
